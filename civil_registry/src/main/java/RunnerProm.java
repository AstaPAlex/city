...
public class RunnerProm {
  ...
  private static void setReport(CivilRegistry civilRegistry) {
    ...
    try {
      Citizen stasChild = new Citizen(sveta.createChild("Стас", "Иванов", "Иванович",
              Gender.MAN, ivan));
      Citizen slavaChild = new Citizen(olga.createChild("Слава", "Кириллов", "Николаевич",
              Gender.MAN, kolya));
      Citizen elenaChild = new Citizen(sveta.createChild("Елена", "Иванова", "Ивановна",
              Gender.WOMAN, ivan));
